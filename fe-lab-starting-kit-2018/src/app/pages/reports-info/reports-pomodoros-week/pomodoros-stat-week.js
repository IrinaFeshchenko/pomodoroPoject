...
/**
 * @class ReportPomodorosWeekComponent
 * @extends WFMComponent
 */
class ReportsPomodorosWeekComponent extends WFMComponent {
    dataStat;
    ...
    */
    ...
    /**
     * @function weekChart
     * Select data of pomodoros for week chart and insert it into chart.
     */
    async weekChart() {
        let arr = this.dates(new Date(Date.now()));
        this.dataStat = await Fierbase.countStatPomodorosWeekByPriority(arr);
...
/** Export ReportsWeekPomodorosComponent to render reports page. */
export const reportsWeekPomodorosComponent = new ReportsPomodorosWeekComponent({
