...
import $ from "jquery";
import { reportMonthModule } from '..';

/**
 * @class ReportsMonthComponent
 * @extends WFMComponent
 */
class ReportsMonthComponent extends WFMComponent {

    /**
     * Constructor extends from WFMComponent.
     * @param  {WFMComponent} config - Constructor of ReportsMonthComponent.
     */
    constructor(config) {
        super(config);
    }
     ...
     * Select data for statistic month and push it to JSON array.
     */
    async setDataToChart() {
        ...
        let data = await Fierbase.countStatTasksMonthByPriority(arr);
    ...
    /**
     * @function datesMonth
     * Select 30 days of current month.
     */
    datesMonth() {
        var today = new Date();
     ...
     * @function weekChart
     * Select 30 days of current month.
     * @param {Array} dataForChart - Data of tasks about this month and iserting it to the charts.
     */
...
/** Export ReportsMonthComponent to render reports page. */
export const reportsMonthComponent = new ReportsMonthComponent({
